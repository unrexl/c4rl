	...
	return (
		...
		>
			...
			<Canvas padding={{ top: 24, left: 24 }}>
				<Label index={0} text="C4RL" font={Enum.Font.GothamBlack} size={20} position={px(0, 0)} />
				<Label index={1} text={VERSION_TAG} position={px(0, 40)} />
				<Label index={2} text="By C4RL" position={px(0, 63)} transparency={0.15} />
				<Label index={3} text="Advanced Script Hub" position={px(0, 86)} transparency={0.3} />
				<Label index={4} text="c4rl/hub" position={new UDim2(0, 0, 1, -40)} transparency={0.45} />
			</Canvas>
		</Card>
	);
}
